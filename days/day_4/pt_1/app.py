...
class Passport(BaseModel):
    byr: int = Field(..., description="Birth Year")
    iyr: int = Field(..., description="Issue Year")
    eyr: int = Field(..., description="Expiration Year")
    hgt: str = Field(..., description="Height")
    hcl: str = Field(..., description="Hair Color")
    ecl: str = Field(..., description="Eye Color")
    pid: str = Field(..., description="Passport ID")

    # optional
    cid: str = Field(None, description="Country ID")
